...
public class Reloj extends JLabel implements Runnable {
    ...
    public void run() {
        ...
        while (ct == hilo) {
            try {
                ...
                Principal.lblHora.setText(txtHora);
                Principal.lblFecha.setText(txtFecha);
                Principal.lblHora.setFont(new java.awt.Font("Comic Sans", 1, 14));//tipo de letra y tamaño
                Principal.lblFecha.setFont(new java.awt.Font("Comic Sans", 1, 14));//tipo de letra y tamaño
    ...
    public void actualiza() {
        ...
        //Aca se acomodan los numeros (si es menos de 9 se le agrega un 0)
